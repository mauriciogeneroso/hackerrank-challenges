...
public class CanYouAccess {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Class<?> innerPrivateClass = CanYouAccess.Inner.class.getDeclaredClasses()[0];

            Constructor<?> constructor = innerPrivateClass.getDeclaredConstructor(CanYouAccess.Inner.class);
